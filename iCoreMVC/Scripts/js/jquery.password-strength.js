...
(function ($) {
	...
	$.fn.password_strength = function (options) {
		...
		return this.each(function () {
			...
			var container = $('<span id="PasswordStrengthInfo"></span>')
            .css({ position: 'absolute', top: 5, left: 355, 'background-color': '#FBFF07', 'font-size': '100%', display: 'inline-block', 'padding-left': 5, 'padding-right': 5, 'border-style': 'solid', 'border-width': 1, 'border-color': 'rgba(0, 0, 0, 0.1)', display: 'none', 'border-radius': 4 });
            ...
            .eq(0).css({ height: 3, top: 5, left: 317, 'border-style': 'solid', 'border-width': 0, 'border-color': '#DDDDDD', padding: 2 }).end()
            .eq(1).css({ height: 12, top: 258, left: 263 }).end()
